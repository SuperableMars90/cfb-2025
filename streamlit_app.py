...
st.markdown('<p>Make your picks for the CFB Bowl Pick \'em challenge here.</p>')
st.markdown('<h3>Scoring</h3><p>The base scoring is 1 point per correct pick. If you parlay picks together, you get additional points if <i>all</i> picks hit. If you miss one, you get 0' \
...
', etc.</p>')
st.markdown('<h3>Form instructions</h3><p>For all the pre-set games (i.e., everything except the later rounds of the playoffs), simpply select the team with the radio button' \
